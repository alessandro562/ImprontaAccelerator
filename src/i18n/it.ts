...
export const it = {
  ...
  hero: {
    ...
    sub: [
      { text: "Impronta è l’acceleratore di impatto di Next4, ELIS Innovation Hub e WDA. " },
      { text: "Sei startup all’anno", strong: true },
      { text: ", " },
      { text: "€150.000 in equity", strong: true },
      { text: " e il confronto diretto con le imprese che cercano quello che stai costruendo." },
    ],
